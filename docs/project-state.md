...
| Test      | Vitest (32 unit/integration) + Playwright (70 E2E) |
| Deploy    | ✅ Vercel (배포 완료)                              |
...
- 14개 단위 테스트 통과 (slug, SEO 유틸) — shared 패키지
- 18개 통합 테스트 통과 (ToolService, CategoryService) — api 패키지
- 70개 E2E 테스트 통과 (Playwright) — 홈, 도구상세, 카테고리, 검색, SEO, 네비게이션, 반응형
...
6. `docs: final project-state.md — MVP deployed to Vercel`
7. `feat: add git hooks, integration tests, and remaining docs`
8. `test: add 70 Playwright E2E tests covering all pages`
